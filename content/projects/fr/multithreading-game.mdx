...
Objectifs du projet :
- Paralléliser les systèmes de jeu (rendu, physique, logique)
- Gestion de ressources thread-safe
- Implémenter un job system
- Optimiser pour des frame times constants

Contraintes :
- C++17/20 avec std::thread
- Pas de race conditions détectables
- Frame time stable < 16ms (60 FPS)
- Profiling et documentation des performances
