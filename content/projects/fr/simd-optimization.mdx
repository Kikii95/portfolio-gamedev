...
Objectifs du projet :
- Implémenter une bibliothèque mathématique SIMD (SSE/AVX)
- Benchmarker contre implémentation scalaire
- Atteindre un speedup minimum de 4x
- Fallback pour plateformes non-SIMD

Contraintes :
- Intrinsics x86 (pas d'assembleur inline)
- Support SSE4.2 minimum, AVX optionnel
- Tests de précision numérique
- Documentation des techniques d'optimisation
